...
echo ' 			<form id="formulario" name="formulario" onsubmit="return validar()" action="tratamientoInsertTerminal.php" method="post">
				<div id="div_marca">
				...
				<div id="div_pantalla">
					...
					<input id="pantalla" name="pantalla" type="text" title="Debe ser con este formato: 240x380" pattern="[0-9]+x[0-9]+" required="required"value="<?php echo $formulario["pantalla"]?>" />
				</div>
				<div id="div_modelo">
